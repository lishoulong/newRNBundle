...
import { getJumpProtocal } from './JumpProtocal';
/*
 * 打开webview页面,统跳协议
 * url: string
 */
 ...
 * url: string
 */
export const openRN = (moduleName, url) => {
    url = encodeURIComponent(url);
    const encodeUrl = `zhuanzhuan://jump/core/rn/jump?moduleName=${moduleName}&downgradeUrl=${url}`
    NativeModules.ZZRCTRouterManager.openUrl(encodeUrl);
}
